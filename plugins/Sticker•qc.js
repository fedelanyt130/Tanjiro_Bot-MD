...
if (mishi.length > 40) return conn.reply(m.chat, '🍃 El texto no puede tener mas de 30 caracteres', m, );
...
let stiker = await sticker(buffer, false, global.botname, global.author);
